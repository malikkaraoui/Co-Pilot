(() => {
  ...
  var require_content = __commonJS({
    "extension/content.js"(exports, module) {
      (function() {
        "use strict";
    ...
    `;
      ...
      `;
          ...
          const detailsBlock = entries ? `<details class="copilot-filter-details">
          <summary>Voir les d\xE9tails</summary>
      ...
      <div class="copilot-premium-section">
        <div class="copilot-premium-blur">
          <div class="copilot-premium-fake">
            <p><strong>Rapport d\xE9taill\xE9 du v\xE9hicule</strong></p>
            <p>Fiche fiabilit\xE9 compl\xE8te avec probl\xE8mes connus, co\xFBts d'entretien pr\xE9vus,
               historique des rappels constructeur et comparaison avec les alternatives du segment.</p>
            <p>Estimation de la valeur r\xE9elle bas\xE9e sur 12 crit\xE8res r\xE9gionaux.</p>
            <p>Recommandation d'achat personnalis\xE9e avec score de confiance.</p>
          </div>
        </div>
        <div class="copilot-premium-overlay">
          <div class="copilot-premium-glass">
            <p class="copilot-premium-title">Analyse compl\xE8te</p>
            <p class="copilot-premium-subtitle">D\xE9bloquez le rapport d\xE9taill\xE9 avec fiabilit\xE9, co\xFBts et recommandations.</p>
      ...
      <div class="copilot-youtube-banner">
        <a href="${escapeHTML(featuredVideo.url)}" target="_blank" rel="noopener noreferrer"
          ...
          <span class="copilot-youtube-text">
            <strong>D\xE9couvrir ce mod\xE8le en vid\xE9o</strong>
            <small>${escapeHTML(channel)}${channel ? " \xB7 " : ""}${escapeHTML(title).substring(0, 50)}</small>
          </span>
    ...
    `;
      ...
      <div class="copilot-email-banner" id="copilot-email-section">
        <button class="copilot-email-btn" id="copilot-email-btn">
          &#x2709; R\xE9diger un email au vendeur
        </button>
        ...
        <div class="copilot-email-loading" id="copilot-email-loading" style="display:none;">
          <span class="copilot-mini-spinner"></span> G\xE9n\xE9ration en cours...
        </div>
    ...
    `;
      ...
      <div class="copilot-popup" id="copilot-popup">
        ...
        <div class="copilot-popup-footer">
          <p>Co-Pilot v1.0 &middot; Analyse automatis\xE9e</p>
        </div>
      </div>
    `;
        }
      ...
      <div class="copilot-popup copilot-popup-error" id="copilot-popup">
        ...
        <div class="copilot-error-body">
          ...
          <button class="copilot-btn copilot-btn-retry" id="copilot-retry">R\xE9essayer</button>
        </div>
      </div>
    `;
        }
    ...
    `;
        ...
        function showProgress() {
          ...
          const html = [
            ...
            `        <div class="copilot-step-text">Extraction des donn\xE9es de l'annonce</div>`,
            "      </div>",
            '      <div class="copilot-step" id="copilot-step-phone" data-status="pending">',
            '        <span class="copilot-step-icon pending">\u25CB</span>',
            '        <div class="copilot-step-text">R\xE9v\xE9lation du num\xE9ro de t\xE9l\xE9phone</div>',
            "      </div>",
            "    </div>",
            '    <div class="copilot-progress-phase">',
            ...
            '        <span class="copilot-step-icon pending">\u25CB</span>',
            '        <div class="copilot-step-text">Demande au serveur : quel v\xE9hicule collecter ?</div>',
            "      </div>",
            ...
            '        <span class="copilot-step-icon pending">\u25CB</span>',
            '        <div class="copilot-step-text">Collecte bonus multi-r\xE9gion</div>',
            "      </div>",
            "    </div>",
            '    <div class="copilot-progress-phase">',
            ...
            '        <span class="copilot-step-icon pending">\u25CB</span>',
            '        <div class="copilot-step-text">D\xE9tection rapport Autoviza</div>',
            "      </div>",
            "    </div>",
            ...
            "        Voir l'analyse compl\xE8te",
            "      </button>",
            "    </div>",
            "  </div>",
            '  <div class="copilot-popup-footer">',
            "    <p>Co-Pilot v1.0 &middot; Analyse en temps r\xE9el</p>",
            "  </div>",
            "</div>"
          ].join("\n");
          showPopup(html);
        ...
        async function runAnalysis() {
          ...
          if (!nextData) {
            console.warn("[CoPilot] extractNextData() \u2192 null. Pas de __NEXT_DATA__ trouv\xE9.");
            progress.update("extract", "error", "Impossible de lire les donn\xE9es");
            showPopup(buildErrorPopup("Impossible de lire les donn\xE9es de cette page. V\xE9rifiez que vous \xEAtes sur une annonce Leboncoin."));
            return;
          }
          ...
          if (ad?.has_phone && isUserLoggedIn()) {
            ...
            progress.update("phone", "skip", "Non connect\xE9 sur LeBonCoin");
          } else {
            progress.update("phone", "skip", "Pas de t\xE9l\xE9phone sur cette annonce");
          }
          ...
          if (vehicle.make && vehicle.model && vehicle.year) {
            ...
            progress.update("job", "skip", "V\xE9hicule incomplet (marque/mod\xE8le/ann\xE9e manquant)");
          ...
          try {
            ...
            if (collectInfo.submitted && collectInfo.isCurrentVehicle) {
              ...
              if (l4 && l4.status === "skip") {
                ...
                progress.update("analyze", "running", "Retry L4 (donn\xE9es fra\xEEches en cours d'\xE9criture)...");
                await sleep(2e3);
            ...
            if (autovizaUrl) {
              progress.update("autoviza", "done", "Rapport gratuit trouv\xE9");
            } else {
        ...
        const COLLECT_COOLDOWN_MS = 24 * 60 * 60 * 1e3;
        ...
        const DEFAULT_SEARCH_RADIUS = 3e4;
        ...
        async function fetchSearchPricesViaApi(searchUrl) {
          ...
          const body = JSON.stringify({
            filters,
            limit: 35,
            // Identique au site web (etait 100 -> detecte comme bot)
            sort_by: "time",
            // Tri par date plus naturel que prix
            sort_order: "desc",
            owner_type: "all"
            // Ajout explicite
          });
