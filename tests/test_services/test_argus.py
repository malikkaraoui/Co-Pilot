...
class TestGetArgusPrice:
    ...
    def _seed(self):
        ...
        db.session.flush()
        a1 = ArgusPrice(
            vehicle_id=v.id, region="Ile-de-France", year=2021,
            mileage_bracket="20000-50000",
            price_low=13000, price_mid=15500, price_high=18000,
            source="seed_test",
        )
        a2 = ArgusPrice(
            vehicle_id=v.id, region="Auvergne-Rhone-Alpes", year=2021,
            mileage_bracket="20000-50000",
            price_low=12500, price_mid=15000, price_high=17500,
            source="seed_test",
        )
