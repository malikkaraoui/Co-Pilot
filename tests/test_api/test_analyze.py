...
class TestAnalyzeEndpoint:
    ...
    def test_eleven_filters_registered(self, client):
        """Les 11 filtres L1-L11 tournent sur une annonce valide."""
        resp = client.post(
            "/api/analyze",
            data=json.dumps({"next_data": VALID_AD_NEXT_DATA}),
            content_type="application/json",
        ...
        assert len(filter_ids) == 11
        for lid in ["L1", "L2", "L3", "L4", "L5", "L6", "L7", "L8", "L9", "L10", "L11"]:
