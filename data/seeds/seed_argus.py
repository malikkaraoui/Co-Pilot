...
ARGUS_DATA = [
    ...
    # BMW Serie 3 -- berline premium (E90/F30/G20)
    ("BMW", "Serie 3", 2007, "Ile-de-France", 5000, 7500, 10000, "80000-150000"),
    ("BMW", "Serie 3", 2007, "Auvergne-Rhone-Alpes", 4500, 7000, 9500, "80000-150000"),
    ("BMW", "Serie 3", 2007, "Nouvelle-Aquitaine", 4500, 7000, 9500, "80000-150000"),
    ("BMW", "Serie 3", 2010, "Ile-de-France", 7000, 9500, 12000, "80000-130000"),
    ("BMW", "Serie 3", 2010, "Auvergne-Rhone-Alpes", 6500, 9000, 11500, "80000-130000"),
    ("BMW", "Serie 3", 2010, "Nouvelle-Aquitaine", 6500, 9000, 11500, "80000-130000"),
    ("BMW", "Serie 3", 2014, "Ile-de-France", 12000, 15000, 18000, "60000-120000"),
    ("BMW", "Serie 3", 2014, "Auvergne-Rhone-Alpes", 11500, 14500, 17500, "60000-120000"),
    ("BMW", "Serie 3", 2014, "Nouvelle-Aquitaine", 11000, 14000, 17000, "60000-120000"),
    ("BMW", "Serie 3", 2018, "Ile-de-France", 18000, 22000, 26000, "40000-80000"),
    ("BMW", "Serie 3", 2018, "Auvergne-Rhone-Alpes", 17500, 21500, 25500, "40000-80000"),
    ("BMW", "Serie 3", 2018, "Nouvelle-Aquitaine", 17000, 21000, 25000, "40000-80000"),
    ("BMW", "Serie 3", 2021, "Ile-de-France", 25000, 30000, 35000, "20000-50000"),
    ("BMW", "Serie 3", 2021, "Auvergne-Rhone-Alpes", 24500, 29500, 34500, "20000-50000"),
    ("BMW", "Serie 3", 2021, "Nouvelle-Aquitaine", 24000, 29000, 34000, "20000-50000"),
