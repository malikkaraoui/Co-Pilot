...
TARGET_MAKES = {
    ...
    "Volkswagen", "Toyota", "Hyundai", "Kia",
    "BMW", "Mercedes-Benz", "Audi", "Ford",
    "Opel", "Fiat", "Nissan", "Skoda", "MINI",
    "Suzuki", "MG", "SEAT", "Volvo", "Mazda",
    "Honda", "Mitsubishi", "Alfa Romeo",
}
        ...
        with open(CSV_PATH, encoding="utf-8") as f:
            ...
            for row in reader:
                ...
                spec = VehicleSpec(
                    ...
                    acceleration_0_100s=float_or_none(
                        row.get("acceleration_0_100_km/h_s", "")
                    ),
